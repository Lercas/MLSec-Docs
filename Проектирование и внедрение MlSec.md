...
- [[#Автоматизированый Red Teaming и RLHF(?) для MLSec|Автоматизированый Red Teaming и RLHF(?) для MLSec]]
...
## Автоматизированый Red Teaming и RLHF(?) для MLSec
...
_(Примечание: В вышеприведённой таблице указаны не все возможные атаки, но она охватывает наиболее распространённые категори)_
...
```
Только эдж-поды с сервисной учёткой etl-service могут обращаться к etl-worker. Любая другая попытка блокируется на уровне мрежевого прокси.
...
> Ссылка на переведенный нами ATLAS - <СЮДА НУЖНА НАША ССЫЛКА>
> 
> Мы не первые, но стараемся ССЫЛКА НА habr итмо
...
ВСТАВИТЬ СЮДА ССЫЛКУ НА MITRE ATLAS
